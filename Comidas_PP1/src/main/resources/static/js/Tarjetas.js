class Tarjetas {
    ...
    showCards(selectedDate) {
        ...
        // "Consulta"
        const cardJson = [
            { fecha: "2025-10-27", datos: { img: "https://picsum.photos/200/120?random=1", title: "Pizza", description: "Pizza con queso, tomate y albahaca" } },
            { fecha: "2025-10-27", datos: { img: "https://picsum.photos/200/120?random=2", title: "Hamburguesa", description: "Hamburguesa simple con papas fritas" } },
            { fecha: "2025-10-28", datos: { img: "https://picsum.photos/200/120?random=3", title: "Ensalada", description: "Ensalada fresca con lechuga, tomate y zanahoria" } },
            { fecha: "2025-10-28", datos: { img: "https://picsum.photos/200/120?random=1", title: "Asado", description: "Asaduti" } },
            { fecha: "2025-10-29", datos: { img: "https://picsum.photos/200/120?random=3", title: "Pescado", description: "Pesezuli" } }
        ];
